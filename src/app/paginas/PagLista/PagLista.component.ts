...
@Component({
  selector: 'app-PagLista',
  templateUrl: './PagLista.component.html',
  styleUrls: ['./PagLista.component.css']
})
export class PagListaComponent implements OnInit {
  ...
  mostrar() {
    this.mostarImagen = !this.mostarImagen
  }
  ...
  */
  /*  consultaVehiculos(){
     this.vehiculoService.getVehiculo(this.filtro).subscribe(data => {
